...
{
    public abstract class MoneyKeeperWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MoneyKeeperWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MoneyKeeperWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MoneyKeeperDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MoneyKeeperDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MoneyKeeperDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MoneyKeeperDbContext, Task<T>> func)
        {
            T result;
