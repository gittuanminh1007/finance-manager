...
namespace MoneyKeeper
{
    ...
    public class MoneyKeeperWebCoreModule : AbpModule
    {
        ...
        public MoneyKeeperWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                 .CreateControllersForAppServices(
                     typeof(MoneyKeeperApplicationModule).GetAssembly()
                 );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(MoneyKeeperWebCoreModule).GetAssembly());
        }

        public override void PostInitialize()
        {
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(MoneyKeeperWebCoreModule).Assembly);
        }
    }
}
